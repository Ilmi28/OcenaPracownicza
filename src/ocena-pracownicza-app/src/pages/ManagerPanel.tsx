...
const ManagerPanel: FC = () => {
    ...
    if (loading) {
        return <Typography sx={{ p: 4 }}>£adowanie danych u¿ytkownika...</Typography>;
    }

    if (!user) {
        return <Typography sx={{ p: 4 }}>B³¹d: U¿ytkownik nie jest zalogowany.</Typography>;
    }
        ...
        <Box sx={{ p: 4, bgcolor: COLORS.MAIN_BACKGROUND, minHeight: '100%' }}>
            ...
            <Box sx={{ mb: 3 }}>
                ...
                <Typography variant="body2" sx={{ color: COLORS.TEXT_SECONDARY_GREY }}>
                    Zarz¹dzaj swoimi danymi osobowymi
                </Typography>
            </Box>
            ...
            <Paper sx={{ p: 3, mb: 3, borderRadius: '8px', bgcolor: COLORS.PAPER_BACKGROUND }}>
                ...
                <Box sx={{
                    ...
                    <ProfileField label="Imiê" value={currentData.imie} icon={PersonOutlineIcon} />
