...
const Sidebar: React.FC<{ drawerWidth: number }> = ({ drawerWidth }) => {
    // Symulacja pobrania roli (docelowo z Twojego AuthProvider)
    const userRole = "Admin"; // To powinno pochodzić z contextu

    return (
        <Drawer variant="permanent" sx={{ width: drawerWidth, flexShrink: 0, '& .MuiDrawer-paper': { width: drawerWidth, boxSizing: 'border-box', bgcolor: 'background.paper', borderRight: '1px solid #D1D5DB' } }}>
            <Toolbar />
